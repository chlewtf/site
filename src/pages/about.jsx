      ...
      <Container className="mt-16 sm:mt-32">
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <SocialLink href="https://x.com/chlewtf" icon={TwitterIcon}>
                Follow on X
              </SocialLink>
              <SocialLink href="https://github.com/chlewtf" icon={GitHubIcon} className="mt-4">
                Follow on GitHub
              </SocialLink>
              <SocialLink
                href="https://instagram.com/chlewtf"
                icon={InstagramIcon}
