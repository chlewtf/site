...
import altare from '@/images/logos/altare.png'
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Get notified when I publish something if you want that for some reason.
      </p>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/chlewtf"
              aria-label="Follow on X"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://github.com/chlewtf"
